  ...
  const navStructure = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: '../daily-operations-management/index.html',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 'adhoc-invoices',
          title: 'Ad-hoc Invoice System',
          description: 'One-off works invoicing',
          icon: 'bi-file-plus',
          link: '../adhoc-invoice-management/index.html',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: 'bi-graph-up',
          link: '../daily-financial-insights/index.html',
        },
        {
          id: 'operation-insights',
          title: 'Daily Operation Insights',
          description: 'Routes, vendors, TW and work hours by date',
          icon: 'bi-bar-chart',
          link: '../daily-operations-reports/index.html',
        },
        {
          ...
          icon: 'bi-speedometer',
          link: '../vendor-performance/index.html',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: 'bi-inbox',
          link: '../requests-admin/index.html',
        },
      ],
    },
    {
