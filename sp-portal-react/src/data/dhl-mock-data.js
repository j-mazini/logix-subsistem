...
(function (global) {
  ...
  var SOP_POSTS = [
    ...
    { id: 4, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '4 days ago', type: 'tutorial', title: 'Package Handling Best Practices', content: 'Learn the essential techniques for handling packages safely and efficiently. Covers proper lifting, stacking, and protection methods.', image: null, video: null, youtubeVideoId: '9bZkp7q19f0', likes: 38, comments: 7, liked: false, commentList: [] },
    { id: 5, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '5 days ago', type: 'tutorial', title: 'Warehouse Safety Protocols', content: 'Critical safety guidelines for warehouse operations. Mandatory viewing for all team members. Follow procedures to prevent accidents.', image: null, video: null, youtubeVideoId: 'xfY6SEb6m7E', likes: 45, comments: 9, liked: false, commentList: [] },
    { id: 6, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '6 days ago', type: 'tutorial', title: 'Customer Service Excellence', content: 'Delivering excellent customer service every time. Learn communication techniques, problem-solving approaches, and professional etiquette.', image: null, video: null, youtubeVideoId: 'aqz-KE-bpKQ', likes: 31, comments: 6, liked: false, commentList: [] },
    { id: 7, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '1 week ago', type: 'info', title: 'Compliance Overview & Regulations', content: 'Understanding compliance requirements and regulations. Important for maintaining service standards and legal obligations.', image: null, video: null, youtubeVideoId: '6Z0NJsDSxVU', likes: 55, comments: 11, liked: false, commentList: [] },
    { id: 8, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '2 weeks ago', type: 'update', title: 'Route Optimization Strategies', content: 'Maximize efficiency through optimal route planning. New algorithms reduce delivery times by up to 15% while improving fuel efficiency.', image: null, video: null, youtubeVideoId: 'kJQDvkKd5OI', likes: 62, comments: 14, liked: false, commentList: [] },
    { id: 9, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '3 weeks ago', type: 'tutorial', title: 'Delivery Excellence Standards', content: 'Achieving delivery excellence every single day. Focus on reliability, professionalism, and customer satisfaction for every delivery.', image: null, video: null, youtubeVideoId: 'YQHsXMglC9A', likes: 48, comments: 10, liked: false, commentList: [] },
    { id: 10, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '4 weeks ago', type: 'info', title: 'Problem Solving in the Field', content: 'Effective problem-solving strategies for field operations. Learn how to handle unexpected situations with confidence and professionalism.', image: null, video: null, youtubeVideoId: 'MNyEJIHdJ9s', likes: 39, comments: 8, liked: false, commentList: [] },
    { id: 11, author: 'DHL Operations', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '5 weeks ago', type: 'update', title: 'Carbon-Neutral Delivery Operations', content: 'DHL opens first operationally carbon-neutral site in UK. Leading the industry in sustainable delivery practices and environmental responsibility.', image: null, video: null, youtubeVideoId: null, likes: 89, comments: 22, liked: false, commentList: [] },
    { id: 12, author: 'DHL Fleet', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '6 weeks ago', type: 'update', title: 'Electric Fleet Expansion Initiative', content: 'DHL acquires Volvo heavy-duty electric trucks in UK first. Revolutionary step toward sustainable last-mile delivery solutions.', image: null, video: null, youtubeVideoId: null, likes: 76, comments: 18, liked: false, commentList: [] },
    { id: 13, author: 'DHL Logistics', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '7 weeks ago', type: 'info', title: 'Waterway Delivery Solutions', content: 'DHL expands delivery network using Thames clipper boats for central London deliveries. Innovative approach to urban logistics challenges.', image: null, video: null, youtubeVideoId: null, likes: 53, comments: 12, liked: false, commentList: [] },
    { id: 14, author: 'DHL Sustainability', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '8 weeks ago', type: 'info', title: 'Green Initiative: Sustainable Packaging', content: 'DHL commits to sustainable packaging solutions. Learn about our transition to eco-friendly materials and how packaging innovations reduce environmental impact while maintaining protection.', image: null, video: null, youtubeVideoId: null, likes: 82, comments: 19, liked: false, commentList: [] },
    { id: 15, author: 'DHL Customer Service', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '9 weeks ago', type: 'tutorial', title: 'Handling Difficult Customer Interactions', content: 'Professional communication strategies for challenging customer situations. Learn de-escalation techniques, empathy-based responses, and how to turn complaints into opportunities.', image: null, video: null, youtubeVideoId: null, likes: 48, comments: 12, liked: false, commentList: [] },
    { id: 16, author: 'DHL Performance', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '10 weeks ago', type: 'update', title: 'Q3 Performance Highlights & Achievements', content: 'Celebrating exceptional Q3 results: 98.5% on-time delivery rate, 15% increase in efficiency metrics, and record customer satisfaction scores. Thank you all for your dedication!', image: null, video: null, youtubeVideoId: null, likes: 124, comments: 31, liked: true, commentList: [{ author: 'Team Member', company: 'DHL', authorAvatar: 'assets/dhl-uk-logo.png', text: 'Great work by everyone! We made a real difference this quarter.', timeAgo: '9 weeks ago' }] },
    { id: 17, author: 'DHL Operations', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '11 weeks ago', type: 'update', title: 'DHL Fleet Expansion: New Vehicles in London', content: 'Expanded our London fleet with modern DHL delivery vehicles equipped with GPS tracking, eco-friendly engines, and improved cargo capacity for better service.', image: 'assets/sop-dhl-truck-london.png', video: null, youtubeVideoId: null, likes: 76, comments: 16, liked: false, commentList: [] },
    { id: 18, author: 'DHL Training', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '12 weeks ago', type: 'tutorial', title: 'Standard Training Procedures Reference', content: 'Complete visual guide to our standardized training procedures. All new team members must review these before operational deployment.', image: 'assets/sop-dhl-innovation-center.png', video: null, youtubeVideoId: null, likes: 52, comments: 10, liked: false, commentList: [] },
    { id: 19, author: 'DHL Safety', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '13 weeks ago', type: 'info', title: 'Essential Safety Equipment & PPE Requirements', content: 'Mandatory safety equipment and personal protective equipment for all warehouse and field operations. Proper use ensures your safety and colleagues.', image: 'assets/sop-barcode-scanner.png', video: null, youtubeVideoId: null, likes: 68, comments: 13, liked: false, commentList: [] },
    { id: 20, author: 'DHL Planning', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '14 weeks ago', type: 'update', title: 'Optimized Route Maps for Key Delivery Areas', content: 'New optimized delivery route maps for major UK metropolitan areas reducing delivery time by 12% while improving efficiency and customer satisfaction.', image: 'assets/sop-dhl-truck-london.png', video: null, youtubeVideoId: null, likes: 71, comments: 14, liked: false, commentList: [] },
    { id: 21, author: 'DHL Field Operations', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '15 weeks ago', type: 'info', title: 'Delivery Checkpoint Verification Process', content: 'Step-by-step guide for checkpoint verification at delivery locations ensuring package security and accurate tracking throughout the delivery chain.', image: 'assets/sop-delivery-driver.png', video: null, youtubeVideoId: null, likes: 54, comments: 9, liked: false, commentList: [] },
    { id: 22, author: 'DHL Compliance', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '16 weeks ago', type: 'update', title: 'Daily Vehicle Inspection Checklist & Guidelines', content: 'Mandatory daily vehicle inspection procedures. Every vehicle must pass safety checks before deployment protecting our fleet and operational excellence.', image: 'assets/sop-dhl-truck-london.png', video: null, youtubeVideoId: null, likes: 59, comments: 11, liked: false, commentList: [] }
  ];
