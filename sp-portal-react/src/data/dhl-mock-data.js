...
(function (global) {
  ...
  var SOP_POSTS = [
    { id: 9, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '10 minutes ago', type: 'update', title: 'Multi-Modal Delivery: Vans & Cargo Bikes in London', content: 'Our London fleet combines vans with zero-emission cargo bikes for cleaner, quieter last-mile deliveries in the city centre. Great teamwork from our drivers and riders keeping deliveries moving sustainably.', video: null, image: 'assets/dhl-cargo-bikes-london.jpg', youtubeVideoId: null, likes: 0, comments: 0, liked: false, commentList: [] },
    { id: 8, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '30 minutes ago', type: 'update', title: 'DHL Express Expands Electric Van Fleet', content: 'DHL Express continues to grow its electric van fleet in the UK, supporting our commitment to zero-emissions last-mile delivery.', video: null, image: null, youtubeVideoId: 'pIFzdppS4Tc', likes: 0, comments: 0, liked: false, commentList: [] },
    { id: 0, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '1 hour ago', type: 'info', title: 'DHL Ambassadors: Our Culture, Safety & Wellbeing', content: 'DHL Ambassadors bring a "Can Do", "Right First Time" and "Passionate" approach to every shift. We are Great Place to Work™ certified, with safety, wellbeing and internal progression at the heart of how we operate, from life on the drays to life in the warehouse.', video: null, image: null, youtubeVideoId: null, likes: 15, comments: 1, liked: false, commentList: [
      { author: 'James T.', company: 'TBX', authorAvatar: 'assets/dhl-uk-logo.png', text: 'Great to see safety and wellbeing taken this seriously.', timeAgo: '50 min ago' }
    ]},
    { id: 6, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '90 minutes ago', type: 'tutorial', title: 'Driver & Employee Training Opportunities', content: 'From health & safety training to soft skills and leadership courses, we invest in your development from day one. Drivers can also upskill their licence category through our training programmes, with support for further education along the way.', video: null, image: null, youtubeVideoId: null, likes: 12, comments: 0, liked: false, commentList: [] },
    { id: 7, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '2 hours ago', type: 'tutorial', title: 'Driving Ambition: Fully Funded LGV Driver Training', content: 'Driving Ambition offers fully funded training worth up to £3,000 to qualify as an LGV driver: Category C (Class 2) for rigid trucks, or C+E (Class 1) for artics. Training runs through dedicated Transport Development Centres across the UK, part of our commitment to zero-emissions logistics by 2050.', image: null, video: null, youtubeVideoId: null, likes: 18, comments: 0, liked: false, commentList: [] },
    { id: 1, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '3 hours ago', type: 'update', title: 'New Depot Hours – MSE & LCY', content: 'Effective from next Monday, MSE and LCY depots will operate extended hours during peak season.', image: null, video: null, youtubeVideoId: null, likes: 24, comments: 0, liked: false, commentList: [] },
    { id: 2, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '1 day ago', type: 'info', title: 'Time Window (TW) Compliance Reminder', content: 'Please ensure all deliveries are completed within the agreed time windows. Repeated misses affect the SP scorecard.', image: null, video: null, youtubeVideoId: null, likes: 42, comments: 0, liked: true, commentList: [] },
    { id: 3, author: 'DHL Operations', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '3 days ago', type: 'update', title: 'Peak Season Preparation Guide', content: 'Comprehensive guide to preparing for the peak season delivery surge: resource allocation, staff training and volume forecasting.', image: null, video: null, youtubeVideoId: null, likes: 38, comments: 0, liked: false, commentList: [] },
    { id: 4, author: 'DHL Safety', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '4 days ago', type: 'info', title: 'Essential Safety Equipment & PPE Requirements', content: 'Mandatory safety equipment and personal protective equipment for all warehouse and field operations.', image: null, video: null, youtubeVideoId: null, likes: 29, comments: 0, liked: false, commentList: [] },
    { id: 5, author: 'DHL Uk', authorAvatar: 'assets/dhl-uk-logo.png', timeAgo: '5 days ago', type: 'tutorial', title: 'Package Handling Best Practices', content: 'Learn the essential techniques for handling packages safely and efficiently: proper lifting, stacking and protection methods.', image: null, video: null, youtubeVideoId: null, likes: 33, comments: 0, liked: false, commentList: [] }
  ];
