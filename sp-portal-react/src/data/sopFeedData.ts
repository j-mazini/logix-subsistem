...
// Local feed images
const FEED_IMAGES = {
  truck_london: 'assets/feed-image-1.jpeg',
  training_procedures: 'assets/feed-image-2.jpeg',
  safety_equipment: 'assets/feed-image-3.jpeg',
  route_map: 'assets/feed-image-4.jpeg',
  delivery_checkpoint: 'assets/feed-image-5.jpeg',
  vehicle_inspection: 'assets/feed-image-6.jpeg',
};
...
const FALLBACK_DHL_POSTS: RawSopPost[] = [
  ...
  },
  {
    ...
    content: 'Expanded our London fleet with modern DHL delivery vehicles equipped with GPS tracking, eco-friendly engines, and improved cargo capacity for better service.',
    image: FEED_IMAGES.truck_london,
    video: null,
    youtubeVideoId: null,
    likes: 76,
    comments: 16,
  ...
  },
  {
    ...
    content: 'Complete visual guide to our standardized training procedures. All new team members must review these before operational deployment.',
    image: FEED_IMAGES.training_procedures,
    video: null,
    youtubeVideoId: null,
    likes: 52,
    comments: 10,
  ...
  },
  {
    ...
    content: 'Mandatory safety equipment and personal protective equipment for all warehouse and field operations. Proper use ensures your safety and colleagues.',
    image: FEED_IMAGES.safety_equipment,
    video: null,
    youtubeVideoId: null,
    likes: 68,
    comments: 13,
  ...
  },
  {
    ...
    content: 'New optimized delivery route maps for major UK metropolitan areas reducing delivery time by 12% while improving efficiency and customer satisfaction.',
    image: FEED_IMAGES.route_map,
    video: null,
    youtubeVideoId: null,
    likes: 71,
    comments: 14,
  ...
  },
  {
    ...
    content: 'Step-by-step guide for checkpoint verification at delivery locations ensuring package security and accurate tracking throughout the delivery chain.',
    image: FEED_IMAGES.delivery_checkpoint,
    video: null,
    youtubeVideoId: null,
    likes: 54,
    comments: 9,
  ...
  },
  {
    ...
    content: 'Mandatory daily vehicle inspection procedures. Every vehicle must pass safety checks before deployment protecting our fleet and operational excellence.',
    image: FEED_IMAGES.vehicle_inspection,
    video: null,
    youtubeVideoId: null,
    likes: 59,
    comments: 11,
