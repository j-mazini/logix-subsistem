...
export function Profile() {
  ...
  if (!sp) {
    return (
      <PortalLayout mainClassName="vendor-admin-main sp-profile-main" headerClassName="sp-profile-page-header" title="My Profile" hideAnnouncements>
  ...
  return (
    <PortalLayout pageClassName="sp-profile-page" mainClassName="vendor-admin-main sp-profile-main" headerClassName="sp-profile-page-header" title="My Profile" hideAnnouncements>
