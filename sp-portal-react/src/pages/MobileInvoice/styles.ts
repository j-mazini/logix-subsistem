export const mobileInvoiceStyles = {
  ...
  sectionPadding: "pb-4",
  listCard:
    "liquid-glass-surface rounded-2xl overflow-hidden relative py-4 px-[clamp(1rem,4vw,1.25rem)] sm:px-5 transition-all duration-300",

  monthHeader:
    "font-bold text-[clamp(0.9375rem,4vw,1rem)] text-slate-800 pt-4 pb-2 border-b-2 border-indigo-500 mb-2 first:mt-0 first:pt-2 flex items-center gap-2",
  monthHeaderIcon: "bi bi-calendar-month text-indigo-600",
  ...
  invoiceTitleIcon: "bi bi-receipt text-indigo-600 flex-shrink-0",
