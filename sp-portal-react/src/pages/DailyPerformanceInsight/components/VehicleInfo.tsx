...
export const VehicleInfo = React.memo<VehicleInfoProps>(({ vehicle }) => {
  return (
    <motion.div
    ...
    >
      ...
      <span className={dailyPerformanceInsightStyles.vehicleInfoText}>{vehicle.vehicleRegistrationPlate} ({vehicle.vehicleModel})</span>
    </motion.div>
  );
});
