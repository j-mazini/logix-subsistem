...
export const DayCard = memo(function DayCard({ date, isSelected, isWeekend, hasNoData, onSelect }: DayCardProps) {
  ...
  return (
    ...
    >
      ...
      {isSelected && <div className="absolute bottom-0 left-0 right-0 h-1 bg-white/50 rounded-b-2xl" />}
    </motion.button>
  );
});
