...
/** Ported verbatim from the reference app's subcontractor/utils.ts. */

// Checks whether an operation represents a "day off"
...
// Computes the Average Hourly Rate
export const calculateAvgHourlyRate = (
  ...
  try {
    ...
    const hoursWorked =
      arrive.getHours() * 60 +
      arrive.getMinutes() -
      (initialWorkHours.getHours() * 60 + initialWorkHours.getMinutes()) -
      breakMinutes;
...
// Whether the stops section should be shown for a given route
