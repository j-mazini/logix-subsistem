...
export function Timeline({ operation }: TimelineProps) {
  ...
  return (
    <div className={dailyPerformanceInsightStyles.timelineContainer}>
      ...
      {timelineItems.map((item) => (
        <div key={item.label} className={dailyPerformanceInsightStyles.timelineItem}>
          <motion.div whileHover={{ scale: 1.1 }} className={`${dailyPerformanceInsightStyles.timelineDot} bg-gradient-to-br ${item.gradient}`}>
