...
const CHECKLIST_TEMPLATE: ChecklistStepTemplate[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Online test released and score reviewed', required: true, detail: 'Release the online test from the interview section. Once the candidate completes it, the score appears in this checklist.' },
      { title: 'DBS collected or requested', required: true },
      { title: 'Work References recorded', required: true, detail: 'Employment history is submitted by the driver in the Driver app (Work history form). References can be collected orally or by letter/e-mail; gaps of 28 days or more are flagged in the 5-year history review.' },
