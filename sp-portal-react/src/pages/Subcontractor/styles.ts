export const subcontractorStyles = {
  ...
  monthSelectorYear:
    "text-[clamp(0.7rem,2.6vw,0.75rem)] text-slate-500 font-medium",
  ...
  operationsDividerWrapper:
    "relative mt-6 mb-6 flex items-center justify-center",
  ...
  metricsLabel:
    "text-[0.65rem] sm:text-[0.7rem] text-slate-600 font-semibold uppercase mb-1 tracking-wide",
  metricsValueBase:
    "text-[clamp(1.1rem,4vw,1.5rem)] font-bold",
  ...
  stopsValue:
    "text-[clamp(1rem,3.6vw,1.125rem)] font-bold leading-none transition-all duration-300",
  stopsLabel:
    "text-[0.6rem] text-slate-500 font-semibold uppercase mt-0.5",
  ...
  paymentCornerBottom:
    "absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-orange-500/10 to-transparent rounded-tr-full",
  paymentTitle:
    "text-[0.85rem] font-bold mb-3.5 text-slate-800 uppercase flex items-center gap-2 relative z-10",
  paymentTitleIcon: "bi bi-cash-stack text-green-600",
  paymentGrid:
    "grid grid-cols-2 gap-3 sm:gap-5 pb-4 relative z-10",
  paymentBaseCard:
    "text-center bg-gradient-to-br from-green-50 to-white p-3 rounded-xl border border-green-100",
  paymentAdhocCard:
    "text-center bg-gradient-to-br from-orange-50 to-white p-3 rounded-xl border border-orange-100",
  paymentBaseLabel:
    "text-sm text-slate-600 font-medium mb-1 block",
  paymentBaseValue:
    "text-[clamp(1.75rem,6vw,2.25rem)] font-bold leading-none text-green-600",
  paymentAdhocLabel:
    "text-sm text-slate-600 font-medium mb-1 block",
  paymentAdhocValue:
    "text-[clamp(1.75rem,6vw,2.25rem)] font-bold leading-none text-orange-600",

  // Notes
  noteCard:
    "relative bg-amber-50 border-l-4 border-amber-200 p-3 rounded-xl mb-3 overflow-visible",
  notePattern:
  ...
  noteTitle:
    "text-[0.7rem] font-bold text-amber-800 uppercase mb-1.5 tracking-wide flex items-center gap-2 relative z-10",
