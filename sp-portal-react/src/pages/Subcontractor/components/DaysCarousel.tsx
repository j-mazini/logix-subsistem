...
export const DaysCarousel = memo(function DaysCarousel({
  ...
  return (
    <div className={subcontractorStyles.daysCarouselWrapper}>
      <div className={subcontractorStyles.daysCarouselBackground} />

      <div
        ref={carouselRef}
        className={subcontractorStyles.daysCarouselScroll}
        style={{
